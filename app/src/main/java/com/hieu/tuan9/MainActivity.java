...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle("Đỗ Lê Huy-1811505310115");
        ...
        arr_bean.add(new ListViewBean(R.drawable.lehuy, "Đỗ Lê Huy","25/11/2000"));
        arr_bean.add(new ListViewBean(R.drawable.lehuy, "Võ Hoàng Lâm","27/09/2000"));
        arr_bean.add(new ListViewBean(R.drawable.lehuy,"Văn Quý Thọ","24/02/2000"));
        arr_bean.add(new ListViewBean(R.drawable.lehuy, "Võ Anh Nguyên","11/1/2000"));
        arr_bean.add(new ListViewBean(R.drawable.lehuy, "Trần Văn Nhật","27/01/2000"));
